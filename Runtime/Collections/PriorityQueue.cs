...
{
    // TODO(리팩토링): 최대 힙이라는 정렬 규칙과 열거 순서를 API 문서에 명시하고,
    // TryPeek/TryPop, 초기 컬렉션 생성자 및 중복 우선순위 동작을 테스트해야 합니다.
    // Unity가 제공하는 .NET PriorityQueue를 사용할 수 있는 버전에서는 대체 가능성도 검토합니다.
